...
class Interleaved_Edges(torch.nn.Module):
    def __init__(self, num_features, n_classes=2, n_hidden=20,n_hidden_edge=20, 
        ...
        #print(fcpy)   
        self.gnn1 = GnnHelper(num_gnn_layers=fcpy.n_gnn_layers, n_hidden=fcpy.n_hidden, edge_updates=config.emlps, final_dropout=fcpy.final_dropout,
                            deg=deg, config=fcpy)
